...
import com.sahariar.librarymanagement.Library.Management.Service.PenaltyService;
...
public class AdminController {
	...
	@RequestMapping("/allfines")
	public String allfines(Model model)
	{
		model.addAttribute("fines", ps.getAll());
		return "admin/fines";
	}
